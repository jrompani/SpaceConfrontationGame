...
namespace SpaceConfrontation
{
    public class Enemy : Sprite
    {
        ...
        public Enemy(int live = 50, Color? color = null)//Constructor. (Parametros opcionales. por defecto va 100 pero se puede cambiar la instancias o dejar vacio valiendo 100)
        {
        ...
        {           
                if (texture == null)
                    texture = Game1.CurrentGame.Content.Load<Texture2D>("Images/Enemy");
                if (explosion == null)
                {
